####
#### CER eDNA study
#### No.6 RMR-078 Fungi: Negative & Positive control check
####

# Load workspace and data
load("05_ReadNSummary_FungiOut/05_ReadNSummary_FungiOut.RData")

# Set random seeds (for reproduction)
ran_seed <- 8181
set.seed(ran_seed)
output_folder06 <- "06_NCcheck_FungiOut"
...
#     file = sprintf("%s/06_NCcheck_FungiOut.RData", output_folder06))
save.image(sprintf("%s/06_NCcheck_FungiOut.RData", output_folder06))
