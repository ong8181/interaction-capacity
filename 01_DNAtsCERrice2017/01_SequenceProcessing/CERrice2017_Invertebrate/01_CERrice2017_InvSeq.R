...
#### No.1 RMR-099 Invertebrate sequence analysis by DADA2
####
...
dir.create("01_CERrice2017_InvSeqOut")
...
path <- "/XXXXXX/01_SequenceProcessing/seqdata_claident/RMR-099-Invertebrate"
...
# Identify primers
FWD <- "GGWACWGGWTGAACWGTWTAYCCYCC" # mlCOIintF
...
out <- filterAndTrim(cutFs, filtFs, cutRs, filtRs,
                     # Remove Ns and prokaryote primers; mlCOIintF = 26 bp, HCO2198 = 26 bp
                     # Output sequences of Claident already trimmed Ns and primers
                     maxN=0, maxEE=c(2,2), truncQ=2, rm.phix=F, minLen = 30,
...
write.table(seqs_out, "01_CERrice2017_InvSeqOut/InvASV_seqs.fa", col.names = FALSE, row.names = FALSE, quote = FALSE)

save.image("01_CERrice2017_InvSeqOut/01_CERrice2017_InvSeq_AllOut.RData")
...
#     file = "01_CERrice2017_InvSeqOut/01_CERrice2017_InvSeqOut.RData")
save.image("01_CERrice2017_InvSeqOut/01_CERrice2017_InvSeqOut.RData")

#### save session info
writeLines(capture.output(sessionInfo()),
           sprintf("00_SessionInfo/01_SessionInfo_InvSeq_%s.txt", substr(Sys.time(), 1, 10)))
