...
#### No.1 RMR-076 Prokaryote sequence analysis by DADA2
####
...
dir.create("01_CERrice2017_ProkSeqOut")
...
# Load sequence reads
# RMR-076-Prokaryote
path <- "/XXXXXX/01_SequenceProcessing/seqdata_claident/RMR-076-Prokaryote"
...
out <- filterAndTrim(cutFs, filtFs, cutRs, filtRs,
                     # remove Ns and prokaryote primers; 515F = 19 bp, 806R = 20 bp
...
write.table(seqs_out, "01_CERrice2017_ProkSeqOut/ProkASV_seqs.fa", col.names = FALSE, row.names = FALSE, quote = FALSE)

save.image("01_CERrice2017_ProkSeqOut/01_CERrice2017_ProkSeq_AllOut.RData")
...
#     file = "01_CERrice2017_ProkSeqOut/01_CERrice2017_ProkSeqOut.RData")
save.image("01_CERrice2017_ProkSeqOut/01_CERrice2017_ProkSeqOut.RData")

#### save session info
writeLines(capture.output(sessionInfo()),
           sprintf("00_SessionInfo/01_SessionInfo_ProkSeq_%s.txt", substr(Sys.time(), 1, 10)))
