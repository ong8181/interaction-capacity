...
load("08_NetworkPropCompileOut/08_NetworkPropCompileOut.RData")

# Set random seeds (for reproduction)
ran_seed <- 8181
set.seed(ran_seed)
output_folder09 <- "09_NetworkPropCCMOut"
...
writeLines(capture.output(sessionInfo()),
           sprintf("00_SessionInfo/%s_SessionInfo_%s.txt", output_folder09, substr(Sys.time(), 1, 10)))
